...
enum FastAndMiddleMAtrendDirection{ NoTrend, Bullish, Bearish };   
FastAndMiddleMAtrendDirection fastAndMiddleMAtrendDirection = FastAndMiddleMAtrendDirection::NoTrend;
...
void tripleMACrossOver(){
  ...
  if(trendDirection != PositionDirection::Bullish && fastMaValue > middleMaValue && middleMaValue > slowMaValue){
      ...
      string message = "" + _Symbol + ":" + currentTimeFrame() + " => Triple MA cross over => Sell signal opportunity.";
      SendNotification(message);
      trendDirection = PositionDirection::Bearish;
  }
}

void fastMaAndMiddleMaCrossOver(){
  double fastMaBufferValue[];  
  double middleMaBufferValue[];  
  ...
  if(fastAndMiddleMAtrendDirection != FastAndMiddleMAtrendDirection::Bullish && fastMaValue > middleMaValue){
      string message = "" + _Symbol + ":" + currentTimeFrame() + " => Fast and Middle MA cross over => Buy signal opportunity.";
      SendNotification(message);
      fastAndMiddleMAtrendDirection = PositionDirection::Bullish;
  }else if(fastAndMiddleMAtrendDirection != FastAndMiddleMAtrendDirection::Bearish && fastMaValue < middleMaValue){
      string message = "" + _Symbol + ":" + currentTimeFrame() + " => Fast and Middle MA cross over => Sell signal opportunity.";
      SendNotification(message);
